...
<head>
    ...
    <title>Frixio - Pagos</title>
    <link rel="icon" type="image/x-icon" href="../../favicon.svg">
    <link rel="stylesheet" href="../../public/<?php echo $version?>/css/clients/pagos.css">
</head>
<body>
    <script src="../../public/<?php echo $version?>/js/dQuery.js" defer></script>
    <script src="../../public/<?php echo $version?>/js/clients/payments.js" defer type="module"></script>
    <main>
        ...
        <section class="center">
            <form>
                ...
                <br><br>
                <label for="frixio-amount">Cantidad</label><br>
